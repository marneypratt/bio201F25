...
ggsave(difference.plot, filename="results/difference.plot.png",  
...
ggsave(effect.plot, filename="results/effect.plot.png",  
...
ggsave(main.time.plot, filename="results/main.time.plot.png",  
...
ggsave(time.effect.plot, filename="results/time.effect.plot.png", 
       height = 5, width = 3, units = "in", 
       dpi = 300)
...
ggsave(main.trt.plot, filename="results/main.trt.plot.png",  
       height = 5, width = 5, units = "in", 
       dpi = 300)
...
ggsave(energy.survey, filename="results/energy.survey.png", 
       height = 4, width = 6, units = "in", 
       dpi = 300)

ggsave(feeling.survey, filename="results/feeling.survey.png", 
       height = 4, width = 6, units = "in", 
       dpi = 300)

ggsave(caff.survey, filename="results/caff.survey.png", 
       height = 4, width = 6, units = "in", 
       dpi = 300)

ggsave(binary.survey, filename="results/binary.survey.png", 
       height = 4, width = 6, units = "in", 
       dpi = 300)
