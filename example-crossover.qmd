...
ggsave(filename = "results/examples/crossover/HRVgraph.png",  
...
# save the graph (.png or .jpg file types are recommended)
ggsave(filename = "results/examples/crossover/crossover.effect.plot.png",    #give your graph a name you will remember
...
# save the graph (.png or .jpg file types are recommended)
ggsave(filename="results/examples/crossover/cross.energy.survey.png", 
       plot = energy.survey,   #put the object name of your survey bar graph here
       height = 1.5, width = 6, units = "in", 
       dpi = 300)

# save the graph (.png or .jpg file types are recommended)
ggsave(filename="results/examples/crossover/cross.feeling.survey.png", 
       plot = feeling.survey,   #put the object name of your survey bar graph here
       height = 1.5, width = 6, units = "in", 
       dpi = 300)

# save the graph (.png or .jpg file types are recommended)
ggsave(filename="results/examples/crossover/cross.caff.survey.png", 
       plot = caff.survey,   #put the object name of your survey bar graph here
       height = 1.5, width = 6, units = "in", 
       dpi = 300)

# save the graph (.png or .jpg file types are recommended)
ggsave(filename="results/examples/crossover/cross.binary.survey.png", 
